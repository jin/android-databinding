```
$ gbazel build :app_prod
Starting local Bazel server and connecting to it...
INFO: SHA256 (https://github.com/cgruber/rules_kotlin/archive/ecc895796f503f43a2f2fb2a120ee54fa597cd34.tar.gz) = 97b5aa8f112de30120e0370370233308dfe211613806ce44d128ef054853216a
DEBUG: Rule 'io_bazel_rules_kotlin' indicated that a canonical reproducible form can be obtained by modifying arguments sha256 = "97b5aa8f112de30120e0370370233308dfe211613806ce44d128ef054853216a"
DEBUG: Call stack for the definition of repository 'io_bazel_rules_kotlin' which is a http_archive (rule definition at /private/var/tmp/_bazel_jingwen/22be5a319b43ffe7bbcc1d52b3964b01/external/bazel_tools/tools/build_defs/repo/http.bzl:292:16):
 - /Users/jingwen/code/android-databinding/BasicSample/WORKSPACE:57:1
Internal error thrown during build. Printing stack trace: java.lang.RuntimeException: Unrecoverable error while evaluating node '//:lib_prod_base BuildConfigurationValue.Key[8fe199b1d7e040eb0f4fce7a691a28cb] false' (requested by nodes '//:lib_prod BuildConfigurationValue.Key[8fe199b1d7e040eb0f4fce7a691a28cb] false', '//:lib_prod_kt BuildConfigurationValue.Key[8fe199b1d7e040eb0f4fce7a691a28cb] false')
...
Caused by: java.lang.NullPointerException
	at com.google.devtools.build.lib.rules.java.JavaCompilationHelper.usesAnnotationProcessing(JavaCompilationHelper.java:434)
...
INFO: Elapsed time: 23.180s
INFO: 0 processes.
FAILED: Build did NOT complete successfully (104 packages loaded, 1383 targets configured)
Internal error thrown during build. Printing stack trace: java.lang.RuntimeException: Unrecoverable error while evaluating node '//:lib_prod_base BuildConfigurationValue.Key[8fe199b1d7e040eb0f4fce7a691a28cb] false' (requested by nodes '//:lib_prod BuildConfigurationValue.Key[8fe199b1d7e040eb0f4fce7a691a28cb] false', '//:lib_prod_kt BuildConfigurationValue.Key[8fe199b1d7e040eb0f4fce7a691a28cb] false')
	at com.google.devtools.build.skyframe.AbstractParallelEvaluator$Evaluate.run(AbstractParallelEvaluator.java:528)
	at com.google.devtools.build.lib.concurrent.AbstractQueueVisitor$WrappedRunnable.run(AbstractQueueVisitor.java:399)
	at java.base/java.util.concurrent.ForkJoinTask$AdaptedRunnableAction.exec(Unknown Source)
...
Caused by: java.lang.NullPointerException
	...
	at com.google.devtools.build.skyframe.AbstractParallelEvaluator$Evaluate.run(AbstractParallelEvaluator.java:451)
	... 7 more
java.lang.RuntimeException: Unrecoverable error while evaluating node '//:lib_prod_base BuildConfigurationValue.Key[8fe199b1d7e040eb0f4fce7a691a28cb] false' (requested by nodes '//:lib_prod BuildConfigurationValue.Key[8fe199b1d7e040eb0f4fce7a691a28cb] false', '//:lib_prod_kt BuildConfigurationValue.Key[8fe199b1d7e040eb0f4fce7a691a28cb] false')
	at com.google.devtools.build.skyframe.AbstractParallelEvaluator$Evaluate.run(AbstractParallelEvaluator.java:528)
	at com.google.devtools.build.lib.concurrent.AbstractQueueVisitor$WrappedRunnable.run(AbstractQueueVisitor.java:399)
	at java.base/java.util.concurrent.ForkJoinTask$AdaptedRunnableAction.exec(Unknown Source)
	at java.base/java.util.concurrent.ForkJoinTask.doExec(Unknown Source)
